...
class StrategyExecutionSnapshotTests(unittest.TestCase):
    ...
    def test_monthly5_signal_override_can_promote_rr_wait_when_quality_recovers(self):
        eth.POSITION_PANEL_STATE["binance_mark_price_ts"] = 1999.0
        decision = {
            "final": "觀望（RR不足）",
            "score": 0.51,
    ...
    def test_monthly5_direct_takeover_bypasses_promotion_and_protected_wait_only(self):
        eth.POSITION_PANEL_STATE["binance_mark_price_ts"] = 1999.0
        decision = {
        ...
        self.assertTrue(override["applied"])
        self.assertTrue(override["direct_takeover"])
        self.assertEqual(override["direction"], "long")
    ...
    def test_monthly5_mixed_bias_probe_does_not_auto_promote_wait(self):
        ...
        monthly5_state = {
            ...
            "market_selection": {
                ...
                "exposure_cap": eth.monthly5_shadow.MIXED_BIAS_PROBE_EXPOSURE_CAP,
                "reason_codes": ["mixed_bias_shadow_probe"],
            },
        }
    ...
    def test_monthly5_context_grace_probe_does_not_auto_promote_wait(self):
        eth.POSITION_PANEL_STATE["binance_mark_price_ts"] = 1999.0
        decision = {
            "final": "觀望（RR不足）",
            "event_risk": 0,
        ...
        monthly5_state = {
            ...
            "market_selection": {
                ...
                "shadow_action": "evaluate_long",
                "exposure_cap": eth.monthly5_shadow.CONTEXT_GRACE_PROBE_EXPOSURE_CAP,
                "reason_codes": ["context_grace_shadow_probe"],
            },
        }
    ...
    def test_monthly5_shadow_preserves_entry_selection_while_position_open(self):
        eth.active_trade.update(
            {
                "open": True,
                "direction": "long",
